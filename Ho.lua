...
-- ============================================================ 
-- STEAL BAR – FORME PILULE (Orvyn style)
-- ============================================================ 
...
local progressRadLbl = Instance.new("TextLabel", sbMain) 
progressRadLbl.Size = UDim2.new(0, 100, 0, 14) 
progressRadLbl.Position = UDim2.new(0, 8, 1, -16) 
progressRadLbl.BackgroundTransparency = 1 
progressRadLbl.Text = "" 
progressRadLbl.TextColor3 = Color3.fromRGB(255, 255, 255) 
progressRadLbl.TextSize = 8
progressRadLbl.Visible = false
